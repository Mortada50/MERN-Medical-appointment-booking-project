...
const Appointment = () => {
  ...
  const { doctors, currencySymbol, backendUrl, getDoctorsData, token, setLoader } =
  ...
  const getAvailableSlots = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        // to hide the booked appointment time and date
    ...
    docInfo && (
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-800">
          ...
          <div className="flex items-center fap-3 w-full overflow-x-scroll mt-4">
            {docSlots.length &&
