...
const MyProfile = () => {
  const { userData, setUserData, backendUrl, token, loadProfileData } =
    ...
    userData && (
      <div className="max-w-lg flex flex-col gap-2 text-sm">
        {isEdit ? (
          <label htmlFor="image">
            <div className="inline-block relative cursor-pointer">
              <img
                className="w-36 h-36 rounded opacity-30 rounded-full"
                src={image ? URL.createObjectURL(image) : userData.image}
                alt=""
              />
              <img
                className="w-10 absolut bottom-12 right-12"
        ...
        {isEdit ? (
          ...
          <p className="font-medium text-3xl text-neutral-600 mt-4">
            {userData.name}
          </p>
        )}
        ...
        <div>
          ...
          <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
            ...
            {isEdit ? (
              <input
                className="bg-gray-100 max-w-25"
                type="text"
